        ...
        messages: [
          {
            role: "system",
            content:
              "You are a senior javascript web developer teaching a 10-year-old how to do web development. Answer questions in concise and simple terms. Be thorough and provide documentation from MDN or other online resources when necessary.",
          },
          { role: "user", content: "in the following array which item is at position zero? fruits[apple, banana, orange, pear]" },
          {
            role: "assistant",
            content:
        "the item at position zero is apple. In an array, the first item is always at position zero and counts upwards from there.",
          },
